#ifndef SPA_SRC_COMMON_EXPRESSIONPROCESSOR_VARIABLENODE_H
#define SPA_SRC_COMMON_EXPRESSIONPROCESSOR_VARIABLENODE_H
...
#endif  // SPA_SRC_COMMON_EXPRESSIONPROCESSOR_VARIABLENODE_H
