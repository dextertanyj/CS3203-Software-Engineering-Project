...
QP::Types::DeclarationList QP::QueryProperties::getDeclarationList() const { return declaration_list; }

QP::Types::SelectList QP::QueryProperties::getSelectList() const { return select_list; }

QP::Types::DeclarationList QP::QueryProperties::getSelectSynonymList() const {
...
QP::Types::ClauseList QP::QueryProperties::getClauseList() const { return clause_list; }
