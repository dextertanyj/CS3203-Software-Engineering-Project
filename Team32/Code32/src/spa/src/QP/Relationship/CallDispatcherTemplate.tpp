...
template <class T>
const unordered_map<QP::Types::ArgumentDispatchKey, QP::Types::ExecutorSetFactory>
	QP::Relationship::CallDispatcherTemplate<T>::wildcard_map = {
		{Types::ReferenceType::Name,
         [](vector<Types::ReferenceArgument> args) {
...
template <class T>
const unordered_map<QP::Types::ArgumentDispatchKey, QP::Types::ExecutorSetFactory>
	QP::Relationship::CallDispatcherTemplate<T>::synonym_map = {
		{Types::ReferenceType::Name,
         [](vector<Types::ReferenceArgument> args) {
			 return pair{
