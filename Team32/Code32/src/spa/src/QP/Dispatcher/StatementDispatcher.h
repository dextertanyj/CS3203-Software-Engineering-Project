...
static QP::Types::ExecutorSetFactory lambda_index_synonym() {
	static const QP::Types::ExecutorSetFactory lambda = [](vector<QP::Types::ReferenceArgument> args) {
		return pair{[lhs = args.at(0), rhs = args.at(1)](QP::StorageAdapter& storage) {
						return QP::Executor::StatementRelationExecutor<T>::executeTrivialIndexSynonym(storage, lhs, rhs);
					},
		            [lhs = args.at(0), rhs = args.at(1)](QP::StorageAdapter& storage) {
						return QP::Executor::StatementRelationExecutor<T>::executeIndexSynonym(storage, lhs, rhs);
					}};
	};
	return lambda;
}
...
static QP::Types::ExecutorSetFactory lambda_wildcard_synonym() {
	static const QP::Types::ExecutorSetFactory lambda = [](vector<QP::Types::ReferenceArgument> args) {
		return pair{[rhs = args.at(1)](QP::StorageAdapter& storage) {
						return QP::Executor::StatementRelationExecutor<T>::executeTrivialWildcardSynonym(storage, rhs);
					},
		            [rhs = args.at(1)](QP::StorageAdapter& storage) {
						return QP::Executor::StatementRelationExecutor<T>::executeWildcardSynonym(storage, rhs);
					}};
	};
	return lambda;
}
...
static QP::Types::ExecutorSetFactory lambda_synonym_synonym() {
	static const QP::Types::ExecutorSetFactory lambda = [](vector<QP::Types::ReferenceArgument> args) {
		return pair{[lhs = args.at(0), rhs = args.at(1)](QP::StorageAdapter& storage) {
						return QP::Executor::StatementRelationExecutor<T>::executeTrivialSynonymSynonym(storage, lhs, rhs);
					},
		            [lhs = args.at(0), rhs = args.at(1)](QP::StorageAdapter& storage) {
						return QP::Executor::StatementRelationExecutor<T>::executeSynonymSynonym(storage, lhs, rhs);
					}};
	};
	return lambda;
}
