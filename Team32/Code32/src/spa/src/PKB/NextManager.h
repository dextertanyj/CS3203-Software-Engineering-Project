...
private:
    ...
    bool
    checkNextStarOptimized(const shared_ptr<StatementNode> &first_node, const shared_ptr<StatementNode> &second_node);
    ...
    void handleTraverseLoopNode(queue<shared_ptr<NodeInterface>> &queue, StmtInfoPtrSet &set,
