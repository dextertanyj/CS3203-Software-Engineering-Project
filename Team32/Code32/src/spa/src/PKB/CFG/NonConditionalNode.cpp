...
PKB::NonConditionalNode::NonConditionalNode(const shared_ptr<StmtInfo>& info) : PKB::StatementNode(NodeType::NonConditional, info) {
...
void PKB::NonConditionalNode::setNext(const shared_ptr<NodeInterface>& next) {
...
void PKB::NonConditionalNode::setPrevious(const shared_ptr<NodeInterface>& prev) {
