...
void PKB::IfNode::setNext(shared_ptr<PKB::NodeInterface> next) { insertNext(next); }

void PKB::IfNode::setPrevious(shared_ptr<PKB::NodeInterface> prev) {
...
void PKB::IfNode::insertIfNext(shared_ptr<PKB::StatementNode> first, shared_ptr<PKB::StatementNode> second) {
    setNext(first);
    setNext(second);
...
void PKB::IfNode::insertIfExit(shared_ptr<PKB::StatementNode> first, shared_ptr<PKB::StatementNode> second) {
