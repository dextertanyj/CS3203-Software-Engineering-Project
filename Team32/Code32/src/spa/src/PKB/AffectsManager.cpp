...
void PKB::AffectsManager::processDFSVisit(Types::DFSInfo &info,
                                          ...
                                          void (AffectsManager::*processor)(Types::DFSInfo &,
                                                                            const shared_ptr<PKB::StatementNode> &)) {
...
void PKB::AffectsManager::processNodeAffects(PKB::Types::DFSInfo &info,
                                             const shared_ptr<PKB::StatementNode> &curr_stmt_node) {
...
void PKB::AffectsManager::processNodeAffected(PKB::Types::DFSInfo &info,
                                              const shared_ptr<PKB::StatementNode> &curr_stmt_node) {
    if (modifies_store->check(curr_stmt_node->getNodeRef(), info.variable)) {
...
void PKB::AffectsManager::processAffectStarBFS(PKB::Types::AffectStarBFSInfo &info,
                                               StmtInfoPtrSet (AffectsManager::*collector)(StmtRef),
