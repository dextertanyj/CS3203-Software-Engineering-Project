...
TEST_CASE("SP::Node::PrintNode::equals Same Object Test") {
    shared_ptr<PrintNode> print_node = make_shared<PrintNode>(1, make_unique<VariableNode>("a"));
    REQUIRE(print_node->equals(move(print_node)));
}
...
TEST_CASE("SP::Node::PrintNode::equals Same Node Test") {
    ...
    REQUIRE(print_node->equals(move(other)));
}
...
TEST_CASE("SP::Node::PrintNode::equals Different Node Test") {
    ...
    REQUIRE_FALSE(print_node->equals(move(other)));
    print_node = make_shared<PrintNode>(1, make_unique<VariableNode>("a"));
