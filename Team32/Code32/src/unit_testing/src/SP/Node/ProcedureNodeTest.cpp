...
TEST_CASE("SP::Node::ProcedureNode::equals Same Object Test") {
    ...
    shared_ptr<ProcedureNode> node = make_shared<ProcedureNode>("testName", move(stmt_lst), 1, 2);
...
TEST_CASE("SP::Node::ProcedureNode::equals Same Node Test") {
    ...
    shared_ptr<ProcedureNode> other = make_shared<ProcedureNode>("testName", move(stmt_lst_2), 1, 2);
...
TEST_CASE("SP::Node::ProcedureNode::equals Different Name Test") {
    ...
    shared_ptr<ProcedureNode> node = make_shared<ProcedureNode>("testName", move(stmt_lst),1 ,2);
    unique_ptr<StatementListNode> stmt_lst_2 = createStatementList("print flag; call x; }", 2);
    shared_ptr<ProcedureNode> other = make_shared<ProcedureNode>("anotherName", move(stmt_lst_2), 1, 2);
...
TEST_CASE("SP::Node::ProcedureNode::equals Different Start Line Number Test") {
    unique_ptr<StatementListNode> stmt_lst = createStatementList("print flag; call x; }", 2);
    shared_ptr<ProcedureNode> node = make_shared<ProcedureNode>("testName", move(stmt_lst), 1, 2);
    unique_ptr<StatementListNode> stmt_lst_2 = createStatementList("print flag; call x; }", 2);
    shared_ptr<ProcedureNode> other = make_shared<ProcedureNode>("testName", move(stmt_lst_2), 2, 2);
    REQUIRE_FALSE(node->equals(other));
}

TEST_CASE("SP::Node::ProcedureNode::equals Different End Line Number Test") {
    unique_ptr<StatementListNode> stmt_lst = createStatementList("print flag; call x; }", 2);
    shared_ptr<ProcedureNode> node = make_shared<ProcedureNode>("testName", move(stmt_lst), 1, 2);
    unique_ptr<StatementListNode> stmt_lst_2 = createStatementList("print flag; call x; }", 2);
    shared_ptr<ProcedureNode> other = make_shared<ProcedureNode>("testName", move(stmt_lst_2), 1, 3);
    REQUIRE_FALSE(node->equals(other));
}
