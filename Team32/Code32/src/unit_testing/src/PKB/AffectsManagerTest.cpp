...
TEST_CASE("PKB::AffectsManager::getAffectsStar Test") {
    ...
    * SIMPLE Code:
    ...
    REQUIRE(affects_manager.getAffectsStar(1) == StmtInfoPtrSet{ assign_stmt_3, assign_stmt_5, assign_stmt_6, assign_stmt_10, assign_stmt_11
}); REQUIRE_THROWS(affects_manager.getAffectsStar(2)); REQUIRE(affects_manager.getAffectsStar(3) == StmtInfoPtrSet{ assign_stmt_3,
assign_stmt_5, assign_stmt_6, assign_stmt_10, assign_stmt_11 }); REQUIRE_THROWS(affects_manager.getAffectsStar(4));
...
TEST_CASE("PKB::AffectsManager::getAffectedStar Test") {
    ...
    * SIMPLE Code:
    ...
    REQUIRE(affects_manager.getAffectsStar(11) == StmtInfoPtrSet{ assign_stmt_1, assign_stmt_3, assign_stmt_5, assign_stmt_6, assign_stmt_9,
assign_stmt_10 });
}
