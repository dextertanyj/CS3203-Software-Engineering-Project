...
TEST_CASE("WithExecutor::execute") {
	...
	SECTION("Trivial: Attribute & Constant") {
		...
		REQUIRE_FALSE(result5.getResult());
		QP::QueryResult result6 = WithExecutor::executeTrivialAttributeConstant(store, if_stmt, invalid_index, if_stmt_internal_executor,
	...
	SECTION("Trivial: Constant & Attribute") {
		...
		REQUIRE_FALSE(result5.getResult());
		QP::QueryResult result6 = WithExecutor::executeTrivialConstantAttribute(store, invalid_index, if_stmt, index_internal_executor,
