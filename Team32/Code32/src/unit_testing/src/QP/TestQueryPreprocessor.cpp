...
TEST_CASE("QP::QueryPreprocessor::parseQuery valid pattern") {
	QueryPattern* clause1;
	QueryPreprocessor qpp1;
	QueryProperties qp1 = qpp1.parseQuery(univDeclarations + "Select a1 pattern a1(v1, _)");
	clause1 = qp1.getPatternClauseList()[0].queryPattern.get();
	REQUIRE((*clause1).getSynonym().type == DesignEntity::assign);
	REQUIRE((*clause1).getSynonym().symbol == "a1");
	...
	clause1 = qp2.getPatternClauseList()[0].queryPattern.get();
	REQUIRE((*clause1).getSynonym().type == DesignEntity::assign);
	REQUIRE((*clause1).getSynonym().symbol == "a1");
	REQUIRE((*clause1).getEntRef().type == EntRefType::synonym);
	REQUIRE((*clause1).getEntRef().entRef == "v1");
	...
	clause1 = qp3.getPatternClauseList()[0].queryPattern.get();
	REQUIRE((*clause1).getSynonym().type == DesignEntity::assign);
	REQUIRE((*clause1).getSynonym().symbol == "a2");
	REQUIRE((*clause1).getEntRef().type == EntRefType::synonym);
	REQUIRE((*clause1).getEntRef().entRef == "v1");
	...
	clause1 = qp4.getPatternClauseList()[0].queryPattern.get();
	REQUIRE((*clause1).getSynonym().type == DesignEntity::assign);
	REQUIRE((*clause1).getSynonym().symbol == "a1");
	...
	clause1 = qp5.getPatternClauseList()[0].queryPattern.get();
	REQUIRE((*clause1).getSynonym().type == DesignEntity::assign);
	REQUIRE((*clause1).getSynonym().symbol == "a1");
	REQUIRE((*clause1).getEntRef().type == EntRefType::underscore);
	REQUIRE((*clause1).getEntRef().entRef == "_");
	...
	clause1 = qp6.getPatternClauseList()[0].queryPattern.get();
	REQUIRE((*clause1).getSynonym().type == DesignEntity::assign);
	REQUIRE((*clause1).getSynonym().symbol == "a1");
	REQUIRE((*clause1).getEntRef().type == EntRefType::underscore);
	REQUIRE((*clause1).getEntRef().entRef == "_");
	...
	clause1 = qp7.getPatternClauseList()[0].queryPattern.get();
	REQUIRE((*clause1).getSynonym().type == DesignEntity::assign);
	REQUIRE((*clause1).getSynonym().symbol == "a1");
	...
	clause1 = qp8.getPatternClauseList()[0].queryPattern.get();
	REQUIRE((*clause1).getSynonym().type == DesignEntity::assign);
	REQUIRE((*clause1).getSynonym().symbol == "a1");
	REQUIRE((*clause1).getEntRef().type == EntRefType::varName);
	REQUIRE((*clause1).getEntRef().entRef == "foo");
	...
	clause1 = qp9.getPatternClauseList()[0].queryPattern.get();
	REQUIRE((*clause1).getSynonym().type == DesignEntity::assign);
	REQUIRE((*clause1).getSynonym().symbol == "a1");
	REQUIRE((*clause1).getEntRef().type == EntRefType::varName);
	REQUIRE((*clause1).getEntRef().entRef == "foo");
...
TEST_CASE("QP::QueryPreprocessor::parseQuery Multiple such that/pattern clauses") {
	...
	QueryPattern* clause1 = qp12.getPatternClauseList()[0].queryPattern.get();
	REQUIRE((*clause1).getSynonym().type == DesignEntity::assign);
	REQUIRE((*clause1).getSynonym().symbol == "a1");
	REQUIRE((*clause1).getEntRef().type == EntRefType::synonym);
	REQUIRE((*clause1).getEntRef().entRef == "v1");
