...
TEST_CASE("QP::QueryPreprocessor::parseQuery valid declarations") {
	...
	REQUIRE(declaration_list1[1].type == QP::Types::DesignEntity::If);
	REQUIRE(declaration_list1[1].symbol == "b");
	REQUIRE(declaration_list1[2].type == QP::Types::DesignEntity::If);
	REQUIRE(declaration_list1[2].symbol == "c");
	REQUIRE(declaration_list1[3].type == QP::Types::DesignEntity::While);
	REQUIRE(declaration_list1[3].symbol == "Select");
	REQUIRE(declaration_list1[4].type == QP::Types::DesignEntity::Read);
	REQUIRE(declaration_list1[4].symbol == "such");
	REQUIRE(declaration_list1[5].type == QP::Types::DesignEntity::Read);
	REQUIRE(declaration_list1[5].symbol == "that");
	REQUIRE(declaration_list1[6].type == QP::Types::DesignEntity::Assign);
	REQUIRE(declaration_list1[6].symbol == "pattern");
	REQUIRE(declaration_list1[7].type == QP::Types::DesignEntity::Variable);
	...
	REQUIRE(declaration_list2[0].type == QP::Types::DesignEntity::Stmt);
	REQUIRE(declaration_list2[0].symbol == "stmt");
	REQUIRE(declaration_list2[1].type == QP::Types::DesignEntity::Read);
	REQUIRE(declaration_list2[1].symbol == "reads");
	REQUIRE(declaration_list2[2].type == QP::Types::DesignEntity::Print);
	REQUIRE(declaration_list2[2].symbol == "p1");
	REQUIRE(declaration_list2[3].type == QP::Types::DesignEntity::Procedure);
	REQUIRE(declaration_list2[3].symbol == "Modifies");
	REQUIRE(declaration_list2[4].type == QP::Types::DesignEntity::Constant);
	...
	REQUIRE(declaration_list3[0].type == QP::Types::DesignEntity::While);
	REQUIRE(declaration_list3[0].symbol == "stmt");
	REQUIRE(declaration_list3[1].type == QP::Types::DesignEntity::If);
	REQUIRE(declaration_list3[1].symbol == "reads");
	REQUIRE(declaration_list3[2].type == QP::Types::DesignEntity::While);
...
TEST_CASE("QP::QueryPreprocessor::parseQuery valid such that Follows(*)") {
	...
	REQUIRE((*clause).getRightStmt().getType() == QP::Types::ReferenceType::Wildcard);
	...
	REQUIRE((*clause).getRightStmt().getType() == QP::Types::ReferenceType::StatementIndex);
	...
	REQUIRE((*clause).getLeftStmt().getType() == QP::Types::ReferenceType::StatementIndex);
	...
	REQUIRE((*clause).getLeftStmt().getType() == QP::Types::ReferenceType::Wildcard);
	REQUIRE((*clause).getRightStmt().getType() == QP::Types::ReferenceType::Synonym);
	...
	REQUIRE((*clause_t).getLeftStmt().getType() == QP::Types::ReferenceType::Synonym);
	REQUIRE((*clause_t).getLeftStmt().getSynonym().symbol == "w1");
	REQUIRE((*clause_t).getRightStmt().getType() == QP::Types::ReferenceType::Synonym);
	...
	REQUIRE((*clause_t).getRightStmt().getType() == QP::Types::ReferenceType::Wildcard);
	REQUIRE((*clause1).getLeftStmt().getType() == QP::Types::ReferenceType::Synonym);
	REQUIRE((*clause1).getLeftStmt().getSynonym().symbol == "w1");
	REQUIRE((*clause1).getRightStmt().getType() == QP::Types::ReferenceType::Synonym);
	REQUIRE((*clause1).getRightStmt().getSynonym().symbol == "c2");
