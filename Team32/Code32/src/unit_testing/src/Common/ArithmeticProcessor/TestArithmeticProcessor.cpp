...
TEST_CASE("Common::ArithmeticProcessor::ArithmeticExpression::parse Basic Test") {
	...
	shared_ptr<ExpressionNode> root =
		make_shared<BinaryOperatorNode>(MathematicalOperator::Plus, make_shared<ConstantNode>("1"), make_shared<ConstantNode>("2"));
...
TEST_CASE("Common::ArithmeticProcessor::ArithmeticExpression::parse Precedence Test") {
	...
	shared_ptr<ExpressionNode> bracketed =
		make_shared<BinaryOperatorNode>(MathematicalOperator::Plus, make_shared<VariableNode>("A"), make_shared<ConstantNode>("1"));
	shared_ptr<ExpressionNode> times = make_shared<BinaryOperatorNode>(MathematicalOperator::Times, bracketed, make_shared<VariableNode>("B"));
	shared_ptr<ExpressionNode> divide =
		make_shared<BinaryOperatorNode>(MathematicalOperator::Divide, make_shared<ConstantNode>("2"), make_shared<ConstantNode>("3"));
	shared_ptr<ExpressionNode> root = make_shared<BinaryOperatorNode>(MathematicalOperator::Plus, times, divide);
