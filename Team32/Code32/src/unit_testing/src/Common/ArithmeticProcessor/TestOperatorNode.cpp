...
TEST_CASE("Common::ArithmeticProcessor::BinaryOperatorNode::equals Same Object Test") {
	shared_ptr<BinaryOperatorNode> op = make_shared<BinaryOperatorNode>(ArithmeticOperator::Plus, make_shared<VariableNode>("A"), make_shared<ConstantNode>("123"));
	REQUIRE(op->equals(op));
}

TEST_CASE("Common::ArithmeticProcessor::BinaryOperatorNode::equals Same Structure Test") {
	shared_ptr<BinaryOperatorNode> op = make_shared<BinaryOperatorNode>(ArithmeticOperator::Plus, make_shared<VariableNode>("A"), make_shared<ConstantNode>("123"));
	shared_ptr<BinaryOperatorNode> other = make_shared<BinaryOperatorNode>(ArithmeticOperator::Plus, make_shared<VariableNode>("A"), make_shared<ConstantNode>("123"));
	REQUIRE(op->equals(other));
}

TEST_CASE("Common::ArithmeticProcessor::BinaryOperatorNode::equals Different Operator Test") {
	shared_ptr<BinaryOperatorNode> op = make_shared<BinaryOperatorNode>(ArithmeticOperator::Plus, make_shared<VariableNode>("A"), make_shared<ConstantNode>("123"));
	shared_ptr<BinaryOperatorNode> other = make_shared<BinaryOperatorNode>(ArithmeticOperator::Times, make_shared<VariableNode>("A"), make_shared<ConstantNode>("123"));
	REQUIRE_FALSE(op->equals(other));
}

TEST_CASE("Common::ArithmeticProcessor::BinaryOperatorNode::equals Different Subexpression Test") {
	shared_ptr<BinaryOperatorNode> op = make_shared<BinaryOperatorNode>(ArithmeticOperator::Plus, make_shared<VariableNode>("A"), make_shared<ConstantNode>("123"));
	shared_ptr<BinaryOperatorNode> other = make_shared<BinaryOperatorNode>(ArithmeticOperator::Plus, make_shared<VariableNode>("B"), make_shared<ConstantNode>("123"));
	REQUIRE_FALSE(op->equals(other));
}

TEST_CASE("Common::ArithmeticProcessor::BinaryOperatorNode::equals Different Type Test") {
	shared_ptr<BinaryOperatorNode> op = make_shared<BinaryOperatorNode>(ArithmeticOperator::Plus, make_shared<VariableNode>("A"), make_shared<VariableNode>("A"));
