...
TEST_CASE("Common::ExpressionProcessor::ExpressionParser{}.parse Acceptor Tests") {
	SECTION("Artihmetic Test") {
		...
		ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Arithmetic);
		REQUIRE_EQUALS(lex.peekToken(), "<");
	}
	SECTION("Relational Test") {
		MockLexer lex = MockLexer(vector<string>({"x", "+", "2", "<", "3", "||", "(", "x", "<", "4", ")"}));
		ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Relational);
		REQUIRE_EQUALS(lex.peekToken(), "||");
	}
}
...
TEST_CASE("Common::ExpressionProcessor::ExpressionParser{}.parse Arithmetic Tests") {
	SECTION("Single Token Test") {
		...
		Expression expression = ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Arithmetic);
	...
	SECTION("Missing Operand Test") {
		...
		REQUIRE_THROWS_AS(ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Arithmetic),
...
TEST_CASE("Common::ExpressionProcessor::ExpressionParser{}.parse Relational Tests") {
	SECTION("Basic Test") {
		MockLexer lex = MockLexer(vector<string>({"1", "<", "2", ";"}));
		Expression expression = ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Relational);
	...
	SECTION("Missing Operator Test") {
		MockLexer lex = MockLexer(vector<string>({"1", "2", "<", "3"}));
		REQUIRE_THROWS_AS(ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Relational),
		                  ExpressionProcessorException);
		REQUIRE_EQUALS(lex.readToken(), "2");
	}
...
TEST_CASE("Common::ExpressionProcessor::ExpressionParser{}.parse Logical Tests") {
	SECTION("Unary Test") {
		...
		Expression expression = ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Logical);
	...
	SECTION("Missing Before Bracket Test") {
		...
		ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Logical);
		REQUIRE(lex.peekToken() == "&&");
	}

	SECTION("Missing After Bracket Test") {
		MockLexer lex = MockLexer(vector<string>({"(", "x", "<", "y", ")", "&&", "z", ">", "3"}));
		REQUIRE_THROWS_AS(ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Logical),
		                  ExpressionProcessorException);
	}
...
TEST_CASE("Common::ExpressionProcessor::Expression::contains Test") {
	...
	SECTION("Single Variable Test") {
		...
		Expression target = ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Arithmetic);
	...
	SECTION("Operator Test") {
		...
		target = ExpressionParser{}.parse(lex, Common::ExpressionProcessor::ExpressionType::Arithmetic);
		REQUIRE(expression.contains(target));
	}
